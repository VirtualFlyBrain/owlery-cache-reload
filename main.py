...
queries = [
    ...
    {"name": "Owlery PartsOf", "template": "http://owl.virtualflybrain.org/kbs/vfb/parts?object=%3Chttp://purl.obolibrary.org/obo/{id}%3E&direct=false&includeDeprecated=false", "id_required": True, "id_filter": _filter_class_only, "allow_fallback": False},
